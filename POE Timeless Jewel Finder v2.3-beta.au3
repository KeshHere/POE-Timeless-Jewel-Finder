...
Local $hGUI = GUICreate("Timeless Jewel Finder-v2.4-beta",770,530) ;gui create
GUISetFont(10)
...
;~ 			ToolTip("Running, Please wait...")
			...
			if $array = '' Then
				MsgBox(0,'Error', 'Please download the 5 CSV files from first zip in release section of GITHUB and put it in the same folder as this app.')
				Exit
			EndIf
			for $line in $array
				if $line <> '' Then
