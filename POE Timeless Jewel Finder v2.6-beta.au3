...
Local $hGUI = GUICreate("Timeless Jewel Finder-v2.6-beta",770,530) ;gui create
GUISetFont(10)
...
$nearList = "26725, near: Cleaving|36634, near: Mind Over Matter|33989, near: Supreme Ego|41263, near: Pain Attunement|60735, near: Wind Dancer|61834, near: Ghost Dance|31683, near: Iron Grip|28475, near: Unwavering Stance|6230, near: Iron Will|48768, near: Solipsism|34483, near: Elemental Equilibrium|7960, near: Zealots Oath|46882, near: Point Blank|55190, near: Divine Shield|61419, near: Hex Master|2491, near: Call to Arms|54127, near: Measured Fury|32763, near: Perfect Agony|26196, near: The Agnostic|33631, near: Eternal Youth|21984, near: Eldritch Battery"
	...
	Switch GUIGetMsg()
		...
		Case $trade
			...
			if GUICtrlRead($JewelCombo) == '' Then
				...
				if $nums <> '' Then
					ShellExecute('https://www.pathofexile.com/trade/search/Sanctum?q='&$tradelink)
;~ 					ShellExecute('https://www.pathofexile.com/trade/search/Hardcore%20Kalandra?q='&$tradelink)
		...
		Case $nearcombo
			...
			if GUICtrlRead($nearcombo) == '61419, near: Hex Master' Then GUICtrlSetData($PassiveList, $nearHexMaster)
